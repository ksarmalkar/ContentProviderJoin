package com.ksarmalkar.jointables.model;

import android.content.ContentValues;
import android.database.Cursor;
import com.ksarmalkar.jointables.helper.DBHelper;
...
public class Person {
    ...
    public static String[] getQualifiedColumns() {
        ...
        for (int i = 0; i < FIELDS.length; i++) {
            qualifiedColumns[i] = DBHelper.addPrefix(Person.TABLE_NAME, FIELDS[i]);
        }
